...
class ReceivedReactionAdapter(
    ...
    override fun onBindViewHolder(holder: ReceivedReactionViewHolder, position: Int) {
        ...
        holder.binding.viewModel = messengerViewModel
        holder.binding.executePendingBindings()
    }

    override fun getItemCount(): Int = reactionsList.size

    class ReceivedReactionViewHolder(val binding: AdapterReceivedReactionItemBinding) :
